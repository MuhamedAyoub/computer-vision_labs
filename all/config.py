...
class ExperimentConfig:
    ...
    cnn_model: str = 'vgg16'  # 'vgg16', 'resnet18', 'resnet50', 'resnet101'
    
    # Feature extraction method for direct classification (not BoVW)
    feature_extraction_method: str = 'cnn'  # 'cnn', 'vit'
    
    # ViT model name (if using ViT)
    vit_model_name: str = 'google/vit-base-patch16-224'

    dsc_method: str = 'cnn'  # 'sift' or 'cnn' (for BoVW descriptors)
    ...
    classifier_type: str = 'svm'  # 'knn' or 'svm'
